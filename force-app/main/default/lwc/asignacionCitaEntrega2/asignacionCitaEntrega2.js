...
export default class AsignacionCitaEntrega2 extends LightningElement {
    ...
    loadProducts() {
        console.log(`LoadProductos recordId: ${this.pageRef.attributes.recordId}`);
    ...
    nextScreen() {
        this.currentScreen += 1;
        console.log(`this.isReasignacion: ${this.isReasignacion} listoFact && !tieneFechaEntrega: ${listoFact} ${tieneFechaEntrega}`);
