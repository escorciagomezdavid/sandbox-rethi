({
    ...
    onDependentFieldChange: function(component, event, helper) {
        ...
        if(tipovalue== "Aplicación de beneficios de campaña" || tipovalue== "Cambio de Vencimiento"
           || tipovalue== "Centrales de Riesgo" || tipovalue== "Comunicación masiva errada" || tipovalue== "Corrección de Pago" 
           || tipovalue== "Declaración de renta" || tipovalue== "Historial de pago" || tipovalue== "Seguros")
        {
            component.set("v.tipovalue", tipovalue); 
            component.set("v.Execute", "standard");   
        }
        
        if(tipovalue== "Solicitud de Extractos")
        {
            component.set("v.Execute", "runFlow");
            component.set("v.CaseName", tipovalue);   
        }
        
        if(tipovalue== "Paz y Salvo") 
        {
            component.set("v.Execute", "runFlow2");
            component.set("v.CaseName", tipovalue);
        }
        
        if(tipovalue== "Certificado de saldo al día") 
        {
            component.set("v.Execute", "runFlow3");
            component.set("v.CaseName", tipovalue);
        }
        
        if(tipovalue== "Solicitud de Cobro a Domicilio") 
        {
            component.set("v.Execute", "runFlow4");
            component.set("v.CaseName", tipovalue);
        }
        
        if(tipovalue== "Negociación") 
        {
            component.set("v.Execute", "runFlow5");
            component.set("v.CaseName", tipovalue);
        }
        
        if(tipovalue== "Garantías") 
        {
            component.set("v.Execute", "runFlow6");
            component.set("v.CaseName", tipovalue);
        }
        
        
         if(tipovalue== "Negociaciones Especiales") 
        {
            component.set("v.Execute", "runFlow7");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Solicitud de Documentos") 
        {
            component.set("v.Execute", "runFlow8");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Transacciones Manuales En Caja") 
        {
            component.set("v.Execute", "runFlow9");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Solicitud Aplicativos Web") 
        {
            component.set("v.Execute", "runFlow10");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Inconvenientes Aplicativos Web") 
        {
            component.set("v.Execute", "runFlow11");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Información General Cartera")
        {
            component.set("v.Execute", "runFlow12");
            component.set("v.CaseName", tipovalue);
        }
         if(tipovalue== "Insatisfacción de Configuración de Credito")
        {
            component.set("v.Execute", "runFlow13");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Activación Póliza Seguro")
        {
            component.set("v.Execute", "runFlow14");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Inconsistencia en centrales de riesgo")
        {
            component.set("v.Execute", "runFlow15");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Atención Inadecuada")
        {
            component.set("v.Execute", "runFlow16");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Comunicación Errada Cartera")
        {
            component.set("v.Execute", "runFlow17");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Inconvenientes Con Aplicación de Pagos")
        {
            component.set("v.Execute", "runFlow18");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Compromiso de Pago")
        {
            component.set("v.Execute", "runFlow19");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Negociación Cartera no Aplicada")
        {
            component.set("v.Execute", "runFlow20");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Solicitud Cancelación de Cuenta")
        {
            component.set("v.Execute", "runFlow21");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Cambio Dia de Pago")
        {
            component.set("v.Execute", "runFlow22");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Contingencia")
        {
            component.set("v.Execute", "runFlow23");
            component.set("v.CaseName", tipovalue);
        }
         if(tipovalue== "Actualizacion de Datos")
        {
            component.set("v.Execute", "runFlow24");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Cliente No Recibio Documento")
        {
            component.set("v.Execute", "runFlow25");
            component.set("v.CaseName", tipovalue);
        }
         if(tipovalue== "Servicio Prioritario")
        {
            component.set("v.Execute", "runFlow26");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Cobro a Domicilio")
        {
            component.set("v.Execute", "runFlow27");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Otras Quejas Cartera")
        {
            component.set("v.Execute", "runFlow28");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Otras Solicitudes Cartera")
        {
            component.set("v.Execute", "runFlow29");
            component.set("v.CaseName", tipovalue);
        }
        if(tipovalue== "Solicitud de cambio en la configuracion de credito")
        {
            component.set("v.Execute", "runFlow30");
            component.set("v.CaseName", tipovalue);
        }
    },
    ...
    createRecord: function(component, event, helper) {
        ...
        if(finishExecute=="runFlow")
        {
            ...
            var inputVariables = [
                ...
                flow.startFlow("SolicituddeExtractos", inputVariables);
